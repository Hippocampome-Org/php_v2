  ...
  //document.getElementById("Potential_Inhibitory_PCL_Only").innerHTML=Potential_Inhibitory_PCL_Only;
   ...
   for (iCol = 0; iCol < cm.length; iCol++) 
	...
	colModel :[
      ...
      {name:'Neuron_type', index:'nickname', width:275,sortable:false,frozen:true},
      ...
      {name:'dg_lp_cajal_retzius_3000p', index:'dg_lp_cajal_retzius_3000p', width:20,height:130,search:false,sortable:false},
      {name:'dg_cajal_retzius_3000', index:'dg_cajal_retzius_3000', width:20,height:130,search:false,sortable:false},
      {name:'dg_mossy_molden_2323', index:'dg_mossy_molden_2323', width:20,height:150,search:false,sortable:false},
      {name:'dg_semilunar_granule_2311p', index:'dg_semilunar_granule_2311p', width:20,height:130,search:false,sortable:false},
      {name:'dg_abi_granule_2203p', index:'dg_abi_granule_2203p', width:20,height:130,search:false,sortable:false},
      {name:'dg_hilar_ectopic_granule_2203p', index:'dg_hilar_ectopic_granule_2203p', width:20,height:150,search:false,sortable:false},
      ...
      {name:'dg_wide_neurogliaform_3300p', index:'dg_wide_neurogliaform_3300p', width:20,height:150,search:false,sortable:false},
      ...
      {name:'dg_basket_granulosum_2232', index:'dg_basket_granulosum_2232', width:20,height:150,search:false,sortable:false},
      ...
      {name:'dg_hiprom_1333p', index:'dg_hiprom_1333p', width:20,height:150,search:false,sortable:false},
      {name:'dg_recurrent_hipp_cap_1103', index:'dg_recurrent_hipp_cap_1103', width:20,height:150,search:false,sortable:false},
      {name:'dg_hipp_cap_1102', index:'dg_hipp_cap_1102', width:20,height:150,search:false,sortable:false},
      {name:'dg_recurrent_hipp_1003', index:'dg_recurrent_hipp_1003', width:20,height:150,search:false,sortable:false},
      {name:'dg_hipp_1002', index:'dg_hipp_1002', width:20,height:150,search:false,sortable:false},
      {name:'dg_ivy_0333', index:'dg_ivy_0333', width:20,height:150,search:false,sortable:false},
      {name:'dg_mocap_0331', index:'dg_mocap_0331', width:20,height:150,search:false,sortable:false},
      {name:'dg_hilus_associated_0003', index:'dg_hilus_associated_0003', width:20,height:150,search:false,sortable:false,
      ...
      {name:'ca3_lmr_targeting_33200', index:'ca3_lmr_targeting_33200', width:20,height:150,search:false,sortable:false},
      {name:'ca3_ppa_projecting_33000p', index:'ca3_ppa_projecting_33000p', width:20,height:150,search:false,sortable:false},
      {name:'ca3_perforant_path_associated_32000', index:'ca3_perforant_path_associated_32000', width:20,height:150,search:false,sortable:false},
      ...
      {name:'ca3_quadd_lm_12222', index:'ca3_quadd_lm_12222', width:20,height:150,search:false,sortable:false},
      ...
      {name:'ca3_recurrent_o_lm_10003', index:'ca3_recurrent_o_lm_10003', width:20,height:150,search:false,sortable:false},
      {name:'ca3_is_quad_03333p', index:'ca3_is_quad_03333p', width:20,height:150,search:false,sortable:false},
      ...
      {name:'ca3_lucidum_orax_03311', index:'ca3_lucidum_orax_03311', width:20,height:150,search:false,sortable:false},
      {name:'ca3_lucidum_radiatum_03300', index:'ca3_lucidum_radiatum_03300', width:20,height:150,search:false,sortable:false},
      ...
      {name:'ca3_is_oriens_01113', index:'ca3_is_oriens_01113', width:20,height:150,search:false,sortable:false},
      {name:'ca3_bilayer_ivy_00330', index:'ca3_bilayer_ivy_00330', width:20,height:150,search:false,sortable:false},
      {name:'ca3_lucidum_00300', index:'ca3_lucidum_00300', width:20,height:150,search:false,sortable:false},
      {name:'ca3_horizontal_basket_cck_00012', index:'ca3_horizontal_basket_cck_00012', width:20,height:150,search:false,sortable:false},
      {name:'ca3_horizontal_axo_axonic_00012', index:'ca3_horizontal_axo_axonic_00012', width:20,height:150,search:false,sortable:false},
      {name:'ca3_so_so_00003', index:'ca3_so_so_00003', width:20,height:150,search:false,sortable:false,
       cellattr: function(rowId, tv, rawObject, cm, rdata) 
       {
             return 'style="border-right:medium solid red;"';
       }},
      ...
      {name:'ca2_bistratified_0333p', index:'ca2_bistratified_0333p', width:20,height:150,search:false,sortable:false},
      ...
      {name:'ca1_lmr_proj_3300', index:'ca1_lmr_proj_3300', width:20,height:150,search:false,sortable:false},
      {name:'ca1_lmr_3300', index:'ca1_lmr_3300', width:20,height:150,search:false,sortable:false},
      {name:'ca1_perforant_path_quadd_3222', index:'ca1_perforant_path_quadd_3222', width:20,height:150,search:false,sortable:false},
      {name:'ca1_perforant_path_3200p', index:'ca1_perforant_path_3200p', width:20,height:150,search:false,sortable:false},
      {name:'ca1_lmr_lm_3200', index:'ca1_lmr_lm_3200', width:20,height:150,search:false,sortable:false},
      ...
      {name:'ca1_radial_trilaminar_2333', index:'ca1_radial_trilaminar_2333', width:20,height:150,search:false,sortable:false},
      {name:'ca1_quadd_rp_2332', index:'ca1_quadd_rp_2332', width:20,height:150,search:false,sortable:false},
      {name:'ca1_schaffer_collateral_2311', index:'ca1_schaffer_collateral_2311', width:20,height:150,search:false,sortable:false},
      {name:'ca1_lmr_r_2300', index:'ca1_lmr_r_2300', width:20,height:150,search:false,sortable:false},
      {name:'ca1_is_lmr_r_2300', index:'ca1_is_lmr_r_2300', width:20,height:150,search:false,sortable:false},
      ...
      {name:'ca1_truncated_basket_2230', index:'ca1_truncated_basket_2230', width:20,height:150,search:false,sortable:false},
      {name:'ca1_is_o_quadd_2223', index:'ca1_is_o_quadd_2223', width:20,height:150,search:false,sortable:false},
      {name:'ca1_is_lmr_o_2201', index:'ca1_is_lmr_o_2201', width:20,height:150,search:false,sortable:false},
      {name:'ca1_is_lm_r_2100', index:'ca1_is_lm_r_2100', width:20,height:150,search:false,sortable:false},
      {name:'ca1_is_lmo_o_2003', index:'ca1_is_lmo_o_2003', width:20,height:130,search:false,sortable:false},
      ...
      {name:'ca1_ro_rp_0312', index:'ca1_ro_rp_0312', width:20,height:150,search:false,sortable:false},
      {name:'ca1_r_rp_0310', index:'ca1_r_rp_0310', width:20,height:150,search:false,sortable:false},
      ...
      {name:'ca1_is_ro_r_0302', index:'ca1_is_ro_r_0302', width:20,height:150,search:false,sortable:false},
      ...
      {name:'ca1_ro_ca3_0202p', index:'ca1_ro_ca3_0202p', width:20,height:150,search:false,sortable:false},
      {name:'ca1_trilaminar_0113p', index:'ca1_trilaminar_0113p', width:20,height:150,search:false,sortable:false},
      {name:'ca1_o_rpo_0113', index:'ca1_o_rpo_0113', width:20,height:150,search:false,sortable:false},
      ...
      {name:'ca1_horiz_axo_axonic_0012', index:'ca1_horiz_axo_axonic_0012', width:20,height:150,search:false,sortable:false},
      {name:'ca1_so_so_proj_0003', index:'ca1_so_so_proj_0003', width:20,height:150,search:false,sortable:false},
      {name:'ca1_so_so_0003', index:'ca1_so_so_0003', width:20,height:150,search:false,sortable:false,
       cellattr: function(rowId, tv, rawObject, cm, rdata) 
       {
         return 'style="border-right:medium solid red;"';
       }
      ...
      {name:'sub_wide_polymorphic_023', index:'sub_wide_polymorphic_023', width:20,height:150,search:false,sortable:false,
       cellattr: function(rowId, tv, rawObject, cm, rdata) 
       {
         return 'style="border-right:medium solid red;"';
       }
      ...
      {name:'ec_deep_pyramidal_V_220033', index:'ec_deep_pyramidal_V_220033', width:20,height:150,search:false,sortable:false},
      {name:'ec_principal_V_220031', index:'ec_principal_V_220031', width:20,height:150,search:false,sortable:false},
      {name:'ec_superficial_pyramidal_mec_V_213330', index:'ec_superficial_pyramidal_mec_V_213330', width:20,height:150,search:false,sortable:false},
      {name:'ec_bipolar_complex_pyramidal_mec_III_133100', index:'ec_bipolar_complex_pyramidal_mec_III_133100', width:20,height:150,search:false,sortable:false},
      {name:'ec_multipolar_lec_III_113330', index:'ec_multipolar_lec_III_113330', width:20,height:150,search:false,sortable:false},
      {name:'ec_multipolar_mec_III_003310', index:'ec_multipolar_mec_III_003310', width:20,height:150,search:false,sortable:false},
      ...
      {name:'ec_neurogliaform_I_300000', index:'ec_neurogliaform_I_300000', width:20,height:130,search:false,sortable:false},
      ...
      {name:'ec_bipolar_III_223311', index:'ec_bipolar_III_223311', width:20,height:150,search:false,sortable:false},
...
-->
        ...
        <!--td align="right"><font class='font5'><p id="cle2"></p></font></td-->
            ...
            <tr height="20">
                ...
                <td><font face="Verdana, Arial, Helvetica, sans-serif" color="#FF0000" size="1">* indicates new v2.0 neuron type</font></td>
            </tr>
