...
/*
	...
	than dynamically looking up ranges in the table SynProEviProTypRel.
	SynProEviProTypRel is where the evidence ids relevant here are
	stored.
*/
class articleevidencerel_synpro
{
	private $_name_table;
