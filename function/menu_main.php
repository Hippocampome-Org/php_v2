...
<body>
	...
	<ul id="css3menu0" class="topmenu">
		...
		<ul>
            ...
            <li><a href="<?php echo $menuaddr ?>synaptome_modeling.php">Synaptic physiology</a></li>
	        ...
	        <li><a href="<?php echo $menuaddr ?>simulation_parameters.php">Simulation parameters</a></li>
		</ul></li>
