...
jQuery(document).ready(function() {
  ...
  $.ajax({
    ...
    cache: false,
    contentType: 'application/json; charset=utf-8',
    url: 'load_matrix_session_counts.php',
    success: function() {}
  });
  $.ajax({
    type: 'GET',
    cache: false,
    contentType: 'application/json; charset=utf-8',
    url: 'load_matrix_session_citations.php',
    success: function() {}
  });
...
require_once("load_matrix_session_counts.php");
require_once("load_matrix_session_citations.php");
//$jsonStr = $_SESSION['Izhikevich_model'];
$jsonStr = $_SESSION['citations'];
...
//    colNames:['','Neuron Type','Rats','Mice','b','d','C','Vr','Vt','Vpeak','Vmin','k0','a0','b0','d0','C0','Vr0','Vt0','Vpeak0','Vmin0','k1','a1','b1','d1','C1','Vr1','Vt1','Vpeak1','Vmin1','G0','P0','k2','a2','b2','d2','C2','Vr2','Vt2','Vpeak2','Vmin2','G1','P1','k3','a3','b3','d3','C3','Vr3','Vt3','Vpeak3','Vmin3','G2','P2']
    colNames:['Citations']
    ,colModel :[
      {name:'type', index:'type', width:500,sortable:false}/*,
      //  {name:'type', index:'type', width:500,sortable:false, cellattr: function (rowId, tv, rawObject, cm, rdata) {
      ...
      {name:'a', index:'a', width:1000,search:false,sortable:false}/*,
...
<div class='title_area'>
  <form id='supertypeForm'>
    <font id= "title" class="font1">Browse neuron type census matrix</font>
  </form>
</div>
